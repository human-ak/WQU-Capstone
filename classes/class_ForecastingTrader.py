...
class ForecastingTrader:
    ...
    def apply_MLP(self, X, y, validation_data, test_data, n_in, hidden_nodes, epochs, optimizer, loss_fct,
        ...
        if len(hidden_nodes)>1:
            plot_model(model, to_file='/mnt/d/GitHub/WQU-Capstone/notebooks/classes/mlp_mpodel_pic/model_{}-{}_{}.png'.format(str(n_in),
                       str(hidden_nodes[0]), str(hidden_nodes[1]), show_shapes=True, show_layer_names=False))
        else:
            plot_model(model, to_file='/mnt/d/GitHub/WQU-Capstone/notebooks/classes/mlp_mpodel_pic/model_{}-{}.png'.format(str(n_in),
    ...
    def apply_RNN(self, X, y, validation_data, test_data, hidden_nodes, epochs, optimizer, loss_fct,
        ...
        model.compile(optimizer=optimizer, loss=loss_fct, metrics=['mae'])
        model.summary()
        plot_model(model, to_file='/mnt/f/etfs/pickle/models/rnn_models/model.png', show_shapes=True,
    ...
    def apply_encoder_decoder(self, X, y, validation_data, test_data, n_in, n_out, hidden_nodes,
        ...
        model.compile(optimizer=optimizer, loss=loss_fct, metrics=['mae'])
        model.summary()
        plot_model(model, to_file='/mnt/d/GitHub/WQU-Capstone/notebooks/classes/encoder_decoder_pics/model.png', show_shapes=True,
                   show_layer_names=False)
    ...
    def run_specific_model(self, n_in, hidden_nodes, pairs, path='models/', train_val_split='2023-01-01', lag=1,
    ...
    def test_specific_model(self, n_in, hidden_nodes, pairs, path, train_test_split='2024-01-01', lag=1,
